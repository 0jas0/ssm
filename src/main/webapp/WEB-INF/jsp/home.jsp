				...
				<td valign="top">
					<div style="position:relative;">
						<div style="text-align:right;font-size:15px;margin:2px 0 0 0;">
							...
							<span style="color:#c1dff7;">角色:</span>
	...
	<div id="HomeFuncAccordion" class="easyui-accordion" style="width:213px;"
		...
		<div title="系统管理" data-options="selected:true" style="padding:10px;">
			<ul id="scheduleMonitor" class="easyui-tree" data-options="animate:true,lines:true">
				<li><span>系统管理</span>
					<ul>
						<li id=11 data-options="attributes:{'url':'teacher/list'}">教师管理</li>
					</ul>
					<ul>
						<li id=12 data-options="attributes:{'url':'student/list'}">学生管理</li>
					</ul>
					<ul>
						<li id=13 data-options="attributes:{'url':'product/find'}">公告管理</li>
					</ul>
				</li>
			</ul>
		</div>

		<div title="课题管理" data-options="selected:true" style="padding:10px">
