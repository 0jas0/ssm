...
<table class="easyui-datagrid" id="customList" title="教师列表" data-options="singleSelect:false,collapsible:true,
		pagination:true,rownumbers:true,url:'teacher/getData', method:'get',pageSize:30, fitColumns:true,
		toolbar:toolbar_teacher">
    <thead>
        <tr>
        	<th data-options="field:'ck',checkbox:true"></th>
            <th data-options="field:'id',width:100,align:'center'">Id</th>
        	<th data-options="field:'serialNumber',width:100,align:'center'">教师编号</th>
            <th data-options="field:'name',width:100,align:'center'">教师名称</th>
