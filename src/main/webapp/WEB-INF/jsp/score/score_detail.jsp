...
<script type="text/javascript">
    $(document).ready(function(){
        $(".AddStudent").click(function () {
            location.href = "/score/score_add?courseId="+${courseId};
        });
        ...
        $(".editStudent").click(function () {
            ...
            $("input[name='selectFlag']:checked").each(function () {
                var scoreId = $(this).closest("tr").find("td:eq(1)").text();
                location.href = "/score/score_edit?scoreId="+scoreId;
            });
        });
    ...
    function page(currentPage,pageSize) {
        $.ajax({
            type: 'post',
            url: '/score/ajax/score-detail-courseId',
            data: {
                'courseId':${courseId},
