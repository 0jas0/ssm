...
<table class="easyui-datagrid" id="customList" title="学生成绩显示" data-options="singleSelect:false,collapsible:true,
		pagination:true,rownumbers:true,url:'', method:'get',pageSize:30, fitColumns:true,
		toolbar:toolbar_teacher">
    <thead>
        <tr>
        	<th data-options="field:'ck',checkbox:true"></th>
			<th data-options="field:'openingReport',width:100,align:'center'">学生姓名</th>
