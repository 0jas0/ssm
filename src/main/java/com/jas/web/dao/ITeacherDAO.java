...
public interface ITeacherDAO {
    ...
    public List<TeacherDO> listTeacherByPage(@Param("keyword") String keyword, @Param("start") Integer start, @Param("size") Integer size, @Param("sort") String sort, @Param("lift") String lift);
